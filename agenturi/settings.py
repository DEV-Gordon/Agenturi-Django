"""
Django settings for agenturi project.
...
SECRET_KEY = 'django-insecure-!zrxq)d-l_u3c^x0qdpf)1k$d413*-calhn^(xyc-2v@!(r_ic'
...
WSGI_APPLICATION = 'agenturi.wsgi.application'
